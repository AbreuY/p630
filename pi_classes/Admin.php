...
//			}			
	...
	public function getAllEdu(){
		$sql="select * from `".parent::SUFFIX."edu`";
		$this->result=$this->query($sql);
	}
	...
	public function getAllEduPage($start, $limit,$sort, $type){
		...
		$sql="select * from `".parent::SUFFIX."edu` order by ". $sort ." ".$type." LIMIT $start, $limit";
		$this->result=$this->query($sql);
	}
	
	public function getEduDtlById($id){
		$sql="select * from `".parent::SUFFIX."edu` where edu_id='".$id."'";
		$this->result=$this->query($sql);
	}
	
	public function deleteEdu($id){
		$sql="delete from `".parent::SUFFIX."edu` where `edu_id` ='".$id."'";
		$this->result=$this->query($sql);
		return $this->result;
	}
