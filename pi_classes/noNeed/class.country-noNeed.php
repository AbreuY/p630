...
class country extends AbstractDB
{
	...
	function getRecordList($select_field='',$whereCnd=''){
		...
		if($whereCnd!='')
		{
			$cnd="select ".$select_field." from ".parent::SUFFIX."country where ".$whereCnd;			
		}
		else
		{
			$cnd="select ".$select_field." from ".parent::SUFFIX."country where 1";
		}
		//echo $cnd;
	...
	public function getCurrencrySymbolByCode($code){
