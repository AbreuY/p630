        ...
        <div class="username_pop_otr">
          <div class="username_text_outer">
            <div class="username_text">
				 <iframe src="http://docs.google.com/gview?url=<?php echo site_path; ?>front_media/product_files/<?php echo $loc; ?>&embedded=true" style="width:600px; height:500px;" frameborder="0"></iframe> 
			<!-- <iframe src="http://docs.google.com/gview?url=http://indicampus.com/rootdir/administrator/admin/jairam/FolderA/Testing.docx&embedded=true" style="width:600px; height:500px;" frameborder="0"></iframe> -->
			</div>
          </div>
       </div>
