    ...
    <div class="about_page_otr">
      ...
      <div class="abt_main_otr">
        ...
        <div class="recent_communication">
            <div class="cmt_otr">
              <div class="cmt_otr_left">
                <div class="cmt_img"><img align="left" src="{$site_path}front_media/images/user_images/180X180px/{$communication['img']}" alt="" title=""><span>To: {$adv_name}</span></div>
              </div>
        ...
        {section name=record loop=$com_rep}
          ...
          <br>
          <form method="post" id="replyFrom" action="{$site_path}user_account/com_reply.php">
          <input type="hidden" name="cid" value="{$communication['communication_id']}">
          <input type="hidden" name="to" value="{$communication['to']}">
