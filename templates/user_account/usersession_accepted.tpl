        ...
        <div class="adviosr_session_msg">
          <div class="edit_menu_start">
            <ul>
              ...
              <li> <a class="edit_act_nav1" href="{$site_path}usersession-accepted" style="width:145px;" > Accepted Request</a></li>
          ...
          <div class="pending_req">
            ...
            <ul>
              ...
              <li> {$i.subject}
              <div class="comment_two"> <a href="{$site_path}userwebcampchkpayment/{$i.webcam_id}">
          ...
          <div class="pending_req">
            ...
            <ul>
              ...
              <li> {$i.subject} 
               <div class="comment_two"> <a href="{$site_path}usermessagechkpayment/{$i.message_id}">
                  <input type="submit" name="" value="Review">
                  </a> </div> 
              </li>
              {foreachelse}
