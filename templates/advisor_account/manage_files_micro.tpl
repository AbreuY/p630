        ...
        <div class="advisor_dash_right_part">{$msg}<div id="mssg"></div>
          ...
          <div class="manage_file_page">
         	...
         	<div class="fld_otr_brws">
              ...
              <ul>
                <li> <a href="{$site_path}manage-files-photo"> Photo </a></li>
                <li> <a  href="{$site_path}manage-files-video"> Video</a></li>
                <li> <a href="{$site_path}manage-files-audio"> Audio</a></li>
                <li> <a href="{$site_path}manage-files-micro" class="edit_act_nav1"> Microsoft</a></li>
                        	...
                        	<tbody>
                                ...
                                <th>Format</th>
                                 ...
                                 <tr>
                                    ...
                                    <td><input type="text" id="file_name_{$i.file_id}" value="{$i.name}" /> <button class="change_name" data-fd="{$i.file_id}">Change Name</button><button class="show_doc" data-loc="{$i.location}">Show Document</button></td>
                                    <td>{$i.size}MB</td>
                                    <td>{$i.format}</td>
                                </tr>
                                {/foreach}
