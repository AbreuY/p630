        ...
        <div class="advisor_dash_front_part">
          <div class="advisor_my_profile_otr">
            <div class="edit_menu_start">
              <ul>
                <li> <a href="{$site_path}active-account/profile-info/{$smarty.get.cd}" class="edit_act_nav1"> Personal Info</a></li>
            ...
            action="{$site_path}advisor_account/advisor_active_account_action.php?cd={$smarty.get.cd}" enctype="multipart/form-data" >
            ...
            <div class="personal_info_otr">
              <div class="personal_info_box">
                ...
                <div class="fld_otr">
                  ...
                  <input type="text" id="email" name="email" value="{$advisorInfo['email']}" readonly="readonly">
                </div>
                <div class="fld_otr">
                    ...
                    <div class="session_req_left">
                      ...
                      <div class="session_req_lef_comment">
                        ...
                        <div class="comment_two">
                         ...
                         {if $advisorInfo['firstPriceWebConsulte'] neq ''}value="{$advisorInfo['firstPriceWebConsulte']|number_format:2}" {else} value="00.00" {/if}>
                        </div>
                        <div class="comment_two">
                         <input type="text" id="repeatPriceWebConsulte" name="repeatPriceWebConsulte" readonly="readonly"
                        {if $advisorInfo['repeatPriceWebConsulte'] neq ''} value="{$advisorInfo['repeatPriceWebConsulte']|number_format:2}" {else} value="00.00" {/if}>
                        </div>
                      </div>
                      <div class="session_req_lef_comment">
...
<!--/End::AutoIncrmnt/-->
<script type="text/javascript" src="{$site_path}front_media/js/advisor_account/advisor_profile_info.js"></script>
