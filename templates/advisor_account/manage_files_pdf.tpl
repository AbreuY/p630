          ...
          <div class="manage_file_page">
         	...
         	<div class="fld_otr_brws">
              ...
              <ul>
                ...
                <li> <a href="{$site_path}manage-files-pdf" class="edit_act_nav1"> PDF</a></li>
              </ul>
            </div>
                        	...
                        	<tbody>
                                ...
                                <th>Format</th>
                                 ...
                                 <tr>
                                    ...
                                    <td><input type="text" id="file_name_{$i.file_id}" value="{$i.name}" /><div> <button class="change_name" data-fd="{$i.file_id}">Change Name</button> <button class="show_image" data-loc="{$i.location}">Show Image</button></div></td>
                                    <td>{$i.size}MB</td>
                                    <td>{$i.format}</td>
                                </tr>
                                {/foreach}
