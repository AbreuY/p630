...
<div id="WrapperOtr">
  <div id="Pageholder"> {*--/Start::Msg/--*} {$msg}  {*--/End::Msg/--*}
    <div class="about_page_otr">
      ...
      <div class="abt_main_otr"> {assign value="abt_active" var=abt_active2}
            ...
            <div class="personal_info_otr">
              <div class="personal_info_box">
                <div class="expertise_otr">
                  ...
                  <div class="fld_otr0_main"> {section name=exprArea loop=$area_expertise_cat}
                    <div class="fld_otr0">
