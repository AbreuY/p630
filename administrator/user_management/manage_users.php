<?php
	...
	if(isset($_REQUEST['btnDeleteAll']))
	{
		for($i=0; $i<$_REQUEST['totalcount']; $i++)
		{
			...
			{	
				//print_r($_REQUEST);
				$objDelEmp->deleteUserDetails($_REQUEST['user_id'.($i+1)]);
				$deleted = true;	
			}
		}
		if($deleted){
...
function change_status(emp_id,status){
	...
	jQuery.ajax({
		...
		success:function(msg){
			window.location.href='<?php echo AbstractDB::SITE_PATH;?>administrator/user_management/manage_users.php?page=<?php echo $_GET['page'];?>';
			Hide_Load();
		}
	})
}
...
<body>
	...
	<section id="main" class="column">
		...
		<?php if(isset($_SESSION['msg']['earn_points_update'])){ ?>
			<h4 class="alert_success">Record updated successfully!</h4>
		<?php 
			unset($_SESSION['msg']['earn_points_update']);
		} ?>	
		...
		?>
		<header>
			<h3 class="tabs_involved">User Management </h3>
		</header>
		<header>
		...
		<div class="tab_container">
			...
			<thead> 
				<tr> 
    				...
    				<th>User Name<a href="<?php echo AbstractDB::SITE_PATH;?>administrator/user_management/manage_users.php?page=<?php echo $_GET['page'];?>&sort=username&type=DESC"><img src="../images/sort_up.gif" border="0" /></a><a href="<?php echo AbstractDB::SITE_PATH;?>administrator/user_management/manage_users.php?page=<?php echo $_GET['page'];?>&sort=username&type=ASC"><img src="../images/sort_down.gif" border="0" /></a></th>
					<!--<th>Last Name <a href="<?php//echo AbstractDB::SITE_PATH;?>administrator/user_management/manage_users.php?page=<?php//echo $_GET['page'];?>&sort=last_name&type=DESC"><img src="../images/sort_up.gif" border="0" /></a><a href="<?php//echo AbstractDB::SITE_PATH;?>administrator/user_management/manage_users.php?page=<?php//echo $_GET['page'];?>&sort=last_name&type=ASC"><img src="../images/sort_down.gif" border="0" /></a></th>-->
					<!--<th>Username <a href="<?php echo AbstractDB::SITE_PATH;?>administrator/manage_users.php?page=<?php echo $_GET['page'];?>&sort=username&type=DESC"><img src="images/sort_up.gif" border="0" /></a><a href="<?php echo AbstractDB::SITE_PATH;?>administrator/manage_users.php?page=<?php echo $_GET['page'];?>&sort=username&type=ASC"><img src="images/sort_down.gif" border="0" /></a></th>-->
					<th>Email <a href="<?php echo AbstractDB::SITE_PATH;?>administrator/user_management/manage_users.php?page=<?php echo $_GET['page'];?>&sort=email&type=DESC"><img src="../images/sort_up.gif" border="0" /></a><a href="<?php echo AbstractDB::SITE_PATH;?>administrator/user_management/manage_users.php?page=<?php echo $_GET['page'];?>&sort=email&type=ASC"><img src="../images/sort_down.gif" border="0" /></a></th>
    				<th>Created On <a href="<?php echo AbstractDB::SITE_PATH;?>administrator/user_management/manage_users.php?page=<?php echo $_GET['page'];?>&sort=created_date&type=DESC"><img src="../images/sort_up.gif" border="0" /></a><a href="<?php echo AbstractDB::SITE_PATH;?>administrator/user_management/manage_users.php?page=<?php echo $_GET['page'];?>&sort=created_date&type=ASC"><img src="../images/sort_down.gif" border="0" /></a></th> 
    				<th>Status</th> 
					<th>Actions</th> 
				</tr> 
			</thead> 
			<tbody> 
					...
					<?php
						$objUserDtl->getAllUserDtlPage($start, $limit,$_REQUEST['sort'],$_REQUEST['type'],'C');
					$i=1;
					$slno=1;
				...
				<tr style='background-color:<?php echo $bg_color;?>;'> 
   					<td>
						...
						<input type="hidden" name="user_id" id="user_id" value="<?php echo base64_encode($objUserDtl->getField('user_id'));?>" />
						<input type="hidden" name="user_id<?=$slno?>" id="user_id<?=$slno?>" value="<?php echo base64_encode($objUserDtl->getField('user_id'));?>" />
					</td> 
    				<td><?php echo $objUserDtl->getField('username');?></td>
    				...
    				<td><?php echo date("jS F Y",strtotime($objUserDtl->getField('created_date')));?> </td> 
					<td>
                    	<a href="javascript:void(0);" onclick="change_status('<?php echo base64_encode($objUserDtl->getField('user_id'));?>','<?php echo $objUserDtl->getField('user_status');?>');">
						<?php echo $objUserDtl->getField('user_status');?>
                    </td> 
    				<td>
						<a href="edit_user.php?user_id=<?php echo base64_encode($objUserDtl->getField('user_id'));?>" title="Edit">
                        <img src="../images/icn_edit.png" border="0" /></a>
					<!--<a href="cust_earn_points.php?user_id=<?//php echo base64_encode($objUserDtl->getField('user_id'));?>" title="Edit User Points">
                    <img src="../images/icon-view.png" border="0"  style="width:20px;height:20px"/></a>-->
					</td> 
				</tr>
				<?php
					$i++;
