...
#ForEditing Details Of Category-Info-Details Action:
	if(isset($_GET['edit_id']) || $_GET['edit_id']!='')
	{
		...
		$Obj->getJobDtlById($edit_id);
		$editJobInfo = $Obj->getAllRow();
	}
    ...
    <article class="module width_full">
      ...
      <div class="module_content">
        ...
        <fieldset style="width:48%; float:left;">
          <label>Job Title <sup style="color:#FF0000;font-weight:bold;">*</sup></label>
          <input type="text" name="name" id="name" value="<?php echo $editJobInfo['name'];?>" style="width:92%;" />
          <input type="hidden" name="job_id" id="job_id" value="<?php echo $editJobInfo['job_id'];?>" style="width:92%;" />
