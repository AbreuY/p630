...
$boxobj=new cms();
$boxUpdtobj=clone $boxobj;
$box_name = urldecode(base64_decode($_GET['box_id']));
...
if($_POST['btnSubmit']=="Update")
{
	...
	$boxUpdtobj->updateBoxContents(base64_decode($_POST['box_id']),$content);	
...
<body>
	...
	<input type="hidden" name="box_id" id="box_id" value="<?php echo $_GET['box_id'];?>" />
	<article class="module width_full" style="width:95%">
		<div id="loading"></div>	
<header><h3><? if(isset($_GET['box_id']) || $_GET['box_id']!='')
{ echo "Edit"; }else{ echo "Add"; }?> BOX </h3></header>

<header>
	<div style="float: left;padding: 5px 0 0 20px;">
		<a href="<?php echo AbstractDB::SITE_PATH;?>admin/manage_box.php" title="Go back"><img src="images/back_icon2.png" border="0" /></a>
	</div>
</header>
	<div class="module_content">
							<fieldset style="width:48%; float:left; margin-right: 3%;">
							<label>Box Name :<sup style="color:#FF0000;font-weight:bold;">*</sup></label>
								<?php echo htmlentities($boxobj->getField('box_name')); ?>
							</fieldset>
							<div class="clear"></div>					
							<fieldset style="width:100%; float:left;">
							<label style="float:none;">Message Content</label>
							<textarea name="content" id="content" rows="25" cols="100" class="mceEditor" style="margin-left: 10px;"> <?php echo html_entity_decode($boxobj->getField('content'));?></textarea>	
							<br /><br />
							</fieldset>
							<div class="clear"></div>
	</div>
