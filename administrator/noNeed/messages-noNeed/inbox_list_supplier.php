<?php
	...
	if(isset($_REQUEST['btnDeleteAll']))
	{
		for($i=0; $i<$_REQUEST['totalcount']; $i++)
		{
			...
			{	
				$objDelEmp->deleteInboxMessageFromSupp($_REQUEST['msg_id'.($i+1)]);
				$deleted = true;	
			}
		}
		if($deleted){
...
<body>
	...
	<section id="main" class="column">
		...
		<?php
			...
			$objInboxMsgDtl->getInboxMsgFromSupplier();
			$targetpage = "inbox_list_supplier.php"; 	
			$limit = 15;
		...
		?>
		<header>
			<h3 class="tabs_involved">Inbox messages from supplier <?php if($unreadCountOfSupp>0){ echo "(".$unreadCountOfSupp.")"; }?></h3>
		</header>
		<header>
		...
		<?php if($unreadCountOfSupp>0)
		{
		?>
		<header>
			You have <?php echo $unreadCountOfSupp; ?> Unread Messages.
		</header>
		<?php
		}
		?>
		<div class="tab_container">
			...
			<thead> 
				<tr> 
    				...
    				<th>From <a href="<?php echo AbstractDB::SITE_PATH;?>admin/messages/inbox_list_supplier.php?page=<?php echo $_GET['page'];?>&sort=supp.company_name&type=DESC"><img src="../images/sort_up.gif" border="0" /></a><a href="<?php echo AbstractDB::SITE_PATH;?>admin/messages/inbox_list_supplier.php?page=<?php echo $_GET['page'];?>&sort=supp.company_name&type=ASC"><img src="../images/sort_down.gif" border="0" /></a></th>
					<th>Subject</th>
					
					<th>Status <a href="<?php echo AbstractDB::SITE_PATH;?>admin/messages/inbox_list_supplier.php?page=<?php echo $_GET['page'];?>&sort=msg.read_msg_flg&type=DESC"><img src="../images/sort_up.gif" border="0" /></a><a href="<?php echo AbstractDB::SITE_PATH;?>admin/messages/inbox_list_supplier.php?page=<?php echo $_GET['page'];?>&sort=msg.read_msg_flg&type=ASC"><img src="../images/sort_down.gif" border="0" /></a></th>
    				<th>Recieved<a href="<?php echo AbstractDB::SITE_PATH;?>admin/messages/inbox_list_supplier.php?page=<?php echo $_GET['page'];?>&sort=msg.msg_date&type=DESC"><img src="../images/sort_up.gif" border="0" /></a><a href="<?php echo AbstractDB::SITE_PATH;?>admin/messages/inbox_list_supplier.php?page=<?php echo $_GET['page'];?>&sort=msg.msg_date&type=ASC"><img src="../images/sort_down.gif" border="0" /></a></th> 
    				<th>Actions</th> 
				</tr> 
			</thead> 
			<tbody> 
					...
					<?php
						$objInboxMsgDtl->getInboxMsgFromSupplierPage($start, $limit,$_REQUEST['sort'],$_REQUEST['type']);
					$i=1;
					$slno=1;
				...
				<tr style='background-color:<?php echo $bg_color;?>;'> 
    				...
    				<td><?php echo $objInboxMsgDtl->getField('company_name')?></td>
					...
					<td>
						<a href="<?php echo ABstractDB::SITE_PATH;?>admin/messages/message_detail.php?type=inbox&user=supplier&message_id=<?php echo base64_encode($objInboxMsgDtl->getField('message_id'));?>" title="Read Detail Message"><img src="../images/icn_edit.png" border="0" /></a>
					</td> 
				</tr>
				<?php
					$i++;
