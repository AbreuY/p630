<?php
	...
	if(isset($_REQUEST['btnDeleteAll']))
	{
		for($i=0; $i<$_REQUEST['totalcount']; $i++)
		{
			...
			{	
				$objDelEmp->deleteCityDetails($_REQUEST['emp_id'.($i+1)]);
				$deleted = true;	
			}
		}
		if($deleted){
...
<body>
	...
	<section id="main" class="column">
		...
		<?php
			...
			$objCountryDtl->getAllActivityCityDtl();
			$targetpage = "list.php"; 	
			$limit = 15;
		...
		?>
		<header>
			<h3 class="tabs_involved">Activity City Management </h3>
		</header>
		<header>
		...
		<div class="tab_container">
			...
			<thead> 
				<tr> 
    				...
    				<th>City ID <a href="<?php echo AbstractDB::SITE_PATH;?>admin/city/list.php?page=<?php echo $_GET['page'];?>&sort=city_id&type=DESC"><img src="../images/sort_up.gif" border="0" /></a><a href="<?php echo AbstractDB::SITE_PATH;?>admin/city/list.php?page=<?php echo $_GET['page'];?>&sort=city_id&type=ASC"><img src="../images/sort_down.gif" border="0" /></a></th>
					<th>City Name <a href="<?php echo AbstractDB::SITE_PATH;?>admin/city/list.php?page=<?php echo $_GET['page'];?>&sort=city_name &type=DESC"><img src="../images/sort_up.gif" border="0" /></a><a href="<?php echo AbstractDB::SITE_PATH;?>admin/city/list.php?page=<?php echo $_GET['page'];?>&sort=city_name&type=ASC"><img src="../images/sort_down.gif" border="0" /></a></th>
					<th>County Name <a href="<?php echo AbstractDB::SITE_PATH;?>admin/city/list.php?page=<?php echo $_GET['page'];?>&sort=country_id&type=DESC"><img src="../images/sort_up.gif" border="0" /></a><a href="<?php echo AbstractDB::SITE_PATH;?>admin/city/list.php?page=<?php echo $_GET['page'];?>&sort=country_id&type=ASC"><img src="../images/sort_down.gif" border="0" /></a></th>
					<th>Lattitued <a href="<?php echo AbstractDB::SITE_PATH;?>admin/city/list.php?page=<?php echo $_GET['page'];?>&sort=lat&type=DESC"><img src="../images/sort_up.gif" border="0" /></a><a href="<?php echo AbstractDB::SITE_PATH;?>admin/city/list.php?page=<?php echo $_GET['page'];?>&sort=lat&type=ASC"><img src="../images/sort_down.gif" border="0" /></a></th>
					<th>Lantitued<a href="<?php echo AbstractDB::SITE_PATH;?>admin/city/list.php?page=<?php echo $_GET['page'];?>&sort=lan&type=DESC"><img src="../images/sort_up.gif" border="0" /></a><a href="<?php echo AbstractDB::SITE_PATH;?>admin/city/list.php?page=<?php echo $_GET['page'];?>&sort=lan&type=ASC"><img src="../images/sort_down.gif" border="0" /></a></th>
			...
			<tbody> 
					...
					<?php
					$objCountryDtl->getAllActivityCityDtlPage($start, $limit,$_REQUEST['sort'],$_REQUEST['type']);
					$i=1;
					$slno=1;
				...
				<tr style='background-color:<?php echo $bg_color;?>;'> 
   					<td>
						...
						<input type="hidden" name="emp_id" id="emp_id" value="<?php echo $objCountryDtl->getField('city_id');?>" />
						<input type="hidden" name="emp_id<?=$slno?>" id="emp_id<?=$slno?>" value="<?php echo $objCountryDtl->getField('city_id');?>" />
					</td> 
    				<td><?php echo $objCountryDtl->getField('city_id');?></td>
					<td><?php echo $objCountryDtl->getField('city_name');?></td>
					<td><?php echo $objCountryDtl->getField('country_name');?></td>
    				<td><?php echo $objCountryDtl->getField('lat');?></td>
					<td><?php echo $objCountryDtl->getField('lan');?></td>
    				<td>
						<a href="add_for_activity.php?act_id=<?php echo $objCountryDtl->getField('city_id');?>" title="Edit"><img src="../images/icn_edit.png" border="0" /></a>
						&nbsp;&nbsp;<a href="manage_tips.php?id=<?php echo $objCountryDtl->getField('city_id');?>" title="Manage Tips"><img src="../images/edit.jpg"  border="0" /></a>
					</td> 
				</tr>
				<?php
					$i++;
