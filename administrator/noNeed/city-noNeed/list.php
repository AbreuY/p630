...
<body>
	...
	<section id="main" class="column">
		...
		?>
		<header>
			<h3 class="tabs_involved">City Management </h3>
		</header>
		<header>
		...
		<div class="tab_container">
			...
			<tbody> 
					...
					<?php
					$objCountryDtl->getAllCityDtlPage($start, $limit,$_REQUEST['sort'],$_REQUEST['type']);
					$i=1;
					$slno=1;
				...
				<tr style='background-color:<?php echo $bg_color;?>;'> 
    				...
    				<td>
						<a href="add.php?act_id=<?php echo $objCountryDtl->getField('city_id');?>" title="Edit"><img src="../images/icn_edit.png" border="0" /></a>
					</td> 
				</tr>
				<?php
					$i++;
