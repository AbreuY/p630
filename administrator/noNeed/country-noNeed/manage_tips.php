...
function updateTipsStatus(tips_id,status)
{
	...
	jQuery.ajax({
		...
		success:function(msg){
			id=<?php echo $_GET['id'];?>;
			window.location.href='<?php echo AbstractDB::SITE_PATH;?>admin/country/manage_tips.php?page=<?php echo $_GET['page'];?>&id='+id;
...
<body>
	...
	<section id="main" class="column">
		...
		<?php
			...
			$objTipsDtl->getCountryCityTips($_REQUEST['id'],'Country');
		...
		?>
		<header>
			<h3 class="tabs_involved">Country Tips Management </h3>
		</header>
		<header>
        
			<div style="float: left;padding: 5px;">
            
				<a href="<?php echo AbstractDB::SITE_PATH;?>admin/country/list_for_activity.php" title="Back"> <img src="../images/back_icon2.png" border="0" /></a>
				&nbsp;&nbsp;
		...
		<div class="tab_container">
			...
			<thead> 
				<tr> 
    				...
    				<th>Tips ID <a href="<?php echo AbstractDB::SITE_PATH;?>admin/country/manage_tips.php?page=<?php echo $_GET['page'];?>&sort=id&type=DESC"><img src="../images/sort_up.gif" border="0" /></a><a href="<?php echo AbstractDB::SITE_PATH;?>admin/country/manage_tips.php?page=<?php echo $_GET['page'];?>&sort=id&type=ASC"><img src="../images/sort_down.gif" border="0"/></a></th>
					<th>Country Name <a href="<?php echo AbstractDB::SITE_PATH;?>admin/country/manage_tips.php?page=<?php echo $_GET['page'];?>&sort=country_name &type=DESC"><img src="../images/sort_up.gif" border="0"/></a><a href="<?php echo AbstractDB::SITE_PATH;?>admin/country/manage_tips.php?page=<?php echo $_GET['page'];?>&sort=country_name&type=ASC"><img src="../images/sort_down.gif" border="0"/></a></th>
                    <th>Status</th>
					<th>Tips Content</th>
					<th> Action </th>
				</tr> 
			...
			<tbody> 
					...
					<?php
					$objTipsDtl->getCountryCityTipsPage($start, $limit,$_REQUEST['sort'],$_REQUEST['type'],$_REQUEST['id'],'Country');
					$i=1;
					$slno=1;
				...
				<tr style='background-color:<?php echo $bg_color;?>;'> 
					...
					<td><?php echo stripslashes($objTipsDtl->getField('country_name'));?></td>
                    <?php
