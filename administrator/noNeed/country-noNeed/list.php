...
<body>
	...
	<section id="main" class="column">
		...
		<?php
			...
			$objCountryDtl->getAllCountryDtl();
			$targetpage = "list.php"; 	
			$limit = 15;
		...
		?>
		<header>
			<h3 class="tabs_involved">Country Management </h3>
		</header>
		<header>
		...
		<div class="tab_container">
			...
			<thead> 
				<tr> 
    				...
    				<th>Country ID <a href="<?php echo AbstractDB::SITE_PATH;?>admin/country/list.php?page=<?php echo $_GET['page'];?>&sort=country_id&type=DESC"><img src="../images/sort_up.gif" border="0" /></a><a href="<?php echo AbstractDB::SITE_PATH;?>admin/country/list.php?page=<?php echo $_GET['page'];?>&sort=country_id&type=ASC"><img src="../images/sort_down.gif" border="0"/></a></th>
					<th>Country Name <a href="<?php echo AbstractDB::SITE_PATH;?>admin/country/list.php?page=<?php echo $_GET['page'];?>&sort=country_name &type=DESC"><img src="../images/sort_up.gif" border="0"/></a><a href="<?php echo AbstractDB::SITE_PATH;?>admin/country/list.php?page=<?php echo $_GET['page'];?>&sort=country_name&type=ASC"><img src="../images/sort_down.gif" border="0"/></a></th>
					<th> Action </th>
				</tr> 
			</thead> 
			<tbody> 
					...
					<?php
					$objCountryDtl->getAllCountryDtlPage($start, $limit,$_REQUEST['sort'],$_REQUEST['type']);
					$i=1;
					$slno=1;
				...
				<tr style='background-color:<?php echo $bg_color;?>;'> 
    				...
    				<td>
						<a href="add.php?act_id=<?php echo $objCountryDtl->getField('country_id');?>" title="Edit"><img src="../images/icn_edit.png"  border="0" /></a>
					</td> 
				</tr>
				<?php
					$i++;
