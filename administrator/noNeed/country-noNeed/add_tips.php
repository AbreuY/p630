...
if($_POST['tips_content']!="")
{
	...
	header("location:manage_tips.php?id=".$_POST['country_id']);
}
?>
...
jQuery(document).ready(function() {
	...
	jQuery('#btnCancel').click(function(){
		location.href="manage_tips.php?id="+jQuery('#country_id').val();
	});
});
</script>
</head>
<body>
	...
	<section id="main" class="column">
		...
		<input type="hidden" name="country_id" value="<?php echo $_REQUEST['id'];?>" />
			...
			<header><h3><?php if(isset($_GET['tips_id'])){ echo "Edit";}else{ echo "Add";}?> Tips</h3></header>
				<header>
					<div style="float: left;padding: 5px 0 0 20px;">
						<a href="<?php echo AbstractDB::SITE_PATH;?>admin/country/manage_tips.php?id=<?php echo $_REQUEST['id'];?>" title="Go back"><img src="../images/back_icon2.png" border="0" /></a>
					</div>
				</header>
