		...
		<div class="tab_container">
			...
			<tbody> 
				...
				<tr style='background-color:<?php echo $bg_color;?>;'> 
    				...
    				<td>
					<a href="<?php echo AbstractDB::SITE_PATH?>admin/activity/edit_activity_pricing.php?activity_id=<?php echo base64_encode($objSubActpriceDtl->getField('activity_id'));?>&user_id=<?php echo base64_encode($objSubActpriceDtl->getField('user_id'));?>&sub_act_type_id=<?php echo base64_encode($objSubActpriceDtl->getField('sub_activity_id'));?>" title="Edit"><img src="../images/icn_edit.png" border="0" /></a> &nbsp;
					</td> 
				</tr>
				<?php
					$i++;
