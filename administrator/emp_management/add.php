...
#ForEditing Details Of Category-Info-Details Action:
	if(isset($_GET['edit_id']) || $_GET['edit_id']!='')
	{
		...
		$Obj->getEmployeeDtlById($edit_id);
		$editEmpInfo = $Obj->getAllRow();
	}
    ...
    <article class="module width_full">
      ...
      <div class="module_content">
        ...
        <fieldset style="width:48%; float:left;">
          <label>Employer Name<sup style="color:#FF0000;font-weight:bold;">*</sup></label>
          <input type="text" name="name" id="name" value="<?php echo $editEmpInfo['name'];?>" style="width:92%;" />
          <input type="hidden" name="emp_id" id="emp_id" value="<?php echo $editEmpInfo['emp_id'];?>" style="width:92%;" />
