...
<body>
	...
	<section id="main" class="column">
		...
		?>
		<header>
			<h3 class="tabs_involved">File Management </h3>
		</header>
		<header>
		...
		<div class="tab_container">
			...
			<tbody> 
					...
					<?php
					$objProGet->getAllAdvForFilePage($start, $limit,$_REQUEST['sort'],$_REQUEST['type']);
					$i=1;
					$slno=1;
				...
				<tr style='background-color:<?php echo $bg_color;?>;'> 
					...
					<td><?php echo $objProGet->getField('first_name');?></td>
					<td><?php echo $objProGet->getField('created_date');?></td>                  
    				<td>
						<a style="font-family: Arial; font-size: 12px; border: 0px none;" href="add.php?edit_id=<?php echo base64_encode($objProGet->getField('advisor_id')); ?>"><img src="../images/icn_edit.png"></a></td>
					</td> 
				</tr>
				<?php
					$i++;
