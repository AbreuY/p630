<?php /* Smarty version Smarty-3.0.8, created on 2013-01-25 06:45:00
         compiled from "../templates/user_account/communication_detail.tpl" */ ?>
<?php /*%%SmartyHeaderCode:20557510229ec113179-23335130%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7de4da4e09308dea51c4a533c83bd9e7e997bd51' => 
    array (
      0 => '../templates/user_account/communication_detail.tpl',
      1 => 1358955760,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '20557510229ec113179-23335130',
  'function' => 
  array (
  ),
...
" alt="" title=""><span>To: <?php echo $_smarty_tpl->getVariable('adv_name')->value;?>
</span></div>
              </div>
...
user_account/com_reply.php">
          <input type="hidden" name="cid" value="<?php echo $_smarty_tpl->getVariable('communication')->value['communication_id'];?>
">
          <input type="hidden" name="to" value="<?php echo $_smarty_tpl->getVariable('communication')->value['to'];?>
">
